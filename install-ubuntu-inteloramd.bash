...
clear
# User confirmation
read -rep $'!!! IMPORTANT !!!\n\nSoftEther VPN(v4.44-9808-rtm-2025.04.16) will be downloaded and compiled on your server.Do you want to continue? [[y/N]] ' response
case "$response" in
[yY][eE][sS]|[yY])
...
wget https://github.com/SoftEtherVPN/SoftEtherVPN_Stable/releases/download/v4.44-9807-rtm/softether-vpnserver-v4.44-9807-rtm-2025.04.16-linux-x64-64bit.tar.gz || exit || exit
sleep 2
